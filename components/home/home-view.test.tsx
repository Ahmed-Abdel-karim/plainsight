...
vi.mock("@/components/city-picker/city-images", () => ({
  cityImages: {
...
vi.mock("@/components/city-picker/city-picker", async (importOriginal) => {
  const actual =
    await importOriginal<
      typeof import("@/components/city-picker/city-picker")
    >();
