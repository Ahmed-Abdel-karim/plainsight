...
export const HIDDEN_PLACE_LABELS: Record<MapTheme, readonly string[]> = {
  dark: [
    "place_city",
    "place_city_large",
    "place_suburb",
...
export const RETAINED_PLACE_LABELS: Record<MapTheme, readonly string[]> = {
...
export const basemapLabelTheme: Record<
  MapTheme,
  { text: string; halo: string }
> = {
