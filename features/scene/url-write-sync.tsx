 ...
 * to mirror: it writes only in `running.idle` (settled) and drops the signal
 * while `navigating`, so a city switch's intermediate clears never clobber the
 * URL. The actual `replaceState` projection lives in the root's `syncUrl`
