 ...
 * hidden (see `scene-view.tsx`) and its content lives in this bottom Drawer. A
 * floating `.map-chrome` bar over the map (city + listing count) is the trigger;
 * vaul provides the grip, scrim, drag-to-dismiss, focus trap, and Esc-to-close.
 *
